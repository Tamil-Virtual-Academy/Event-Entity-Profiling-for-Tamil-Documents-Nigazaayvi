...
foreach $k(@file)
{
	...
	$cmd1="perl combineNElist_DD.pl /home/aukbc/apache-tomcat-8.0.18/webapps/tvademo/new-TVA-29March2017/AnaphoraCoreferenceModule_v1/interDD /home/aukbc/apache-tomcat-8.0.18/webapps/tvademo/new-TVA-29March2017/PipelineModule/NEsFile.txt >/home/aukbc/apache-tomcat-8.0.18/webapps/tvademo/new-TVA-29March2017/PipelineModule/newNEsFile.txt";
	system($cmd1);
	...
	$newsNEsList="";
	open(EH,"/home/aukbc/apache-tomcat-8.0.18/webapps/tvademo/new-TVA-29March2017/PipelineModule/NEsFile_UTF.txt");
	while(<EH>){
		chomp; 
		next if($_ =~ /^\s*$/);
		$newNEsList.=$_;
	...
	$causeeffect="<ol>";
	$causeeffect1="";
	open(ED,"/home/aukbc/apache-tomcat-8.0.18/webapps/tvademo/new-TVA-29March2017/causeEffectSys/causeEffectOut_utf8.txt");
	while(<ED>){
		#chomp;
		next if($_=~ /^\s*$/);
		$causeeffect.="<li>$_<\/li>";
	...
	print XR "<field name=\"causeeffect\">$causeeffect1<\/field>\n"; 
	...
	$content=~s/\n/<br>/g;
	###write to HTML file
	open(HR,">/home/aukbc/apache-tomcat-8.0.18/webapps/tvademo/final_Output.html");
	print HR "<html>\n";
