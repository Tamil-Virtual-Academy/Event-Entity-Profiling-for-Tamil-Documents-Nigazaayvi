...
perl putInColumnAna.pl output_stage2.txt > output_stage2_html.txt
java convert_WX_UTF_tam -i output_stage2_html.txt -o /home/nlp/apache-tomcat-8.5.23//webapps/tvademo/Anaphora_Output.html
