...
perl suff.pl 1ner_wx_interim1.txt > 1ner_inter2
perl verb1.pl 1ner_inter2 > 1ner_inter3
crf_test -m model-new 1ner_inter3  > 1crfner_interimOut.txt
perl remov-col.pl 1crfner_interimOut.txt > 2crfner_interimOut.txt
perl merge-two-files.pl 1ner_wx_interim1.txt  2crfner_interimOut.txt > 1inter1.txt
...
perl new-ne-tag-dict.pl tag-dict.txt out-post.txt > 1inter-ner.txt
