...
open(RD,"/home/nlp/apache-tomcat-8.5.23//webapps/tvademo/new-TVA-29March2017/ClauseIdentifierModule/Clause_outout.txt");
while(<RD>){
        chomp;
        push(@tempArr,$_);
}
...
print HR "<table>\n";
print HR "<tr><td><b>Word<\/b><\/td><td><b>POS<\/b><\/td><td><b>Chunk<\/b><\/td><td><b>Morph-Analysis<\/b><\/td><td><b>ClauseTag<\/b><\/td><\/tr>\n";
